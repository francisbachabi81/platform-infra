...
# Used by env=qa AKS routing logic to land cluster in shared nonprod subscription.
...
# AKS (env)
# qa: deploys into shared nonprod core RG; nodepool in nonprod hub (akspub/akshrz)
create_aks         = false
...
servicebus_authorization_rules_override = {
  ...
  cn = {
    name   = "sb-qa-cn-manage"
    manage = true
  }
  ivl = {
    name   = "sb-qa-ivl-manage"
    manage = true
  }
}
...
# Worker nodes: keep 0 in qa if you just want to validate plumbing.
cdbpg_node_count = 0
