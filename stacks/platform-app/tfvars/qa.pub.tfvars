...
# cdbpg_admin_password is provided by workflow via TF_VAR_cdbpg_admin_password
...
# pg_admin_password is provided by workflow via TF_VAR_pg_admin_password
...
# ── Front Door (Commercial often enabled—even in QA) ─────────────────────────
