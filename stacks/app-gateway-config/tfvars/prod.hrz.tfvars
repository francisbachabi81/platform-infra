...
shared_network_state = {
  ...
  key                  = "shared-network/prod.hrz.tfstate"
}
...
#   storage_account_name = "stterraformstate"
#   container_name       = "tfstate"
#   key                  = "platform-app/prod.hrz.tfstate"
# }

# SSL cert in Key Vault
ssl_secret_name        = "agw-prod-cert"        # secret name containing the PFX
...
backend_pools = {
  bepool-api = {
    fqdns = ["api-prod.internal.contoso.local"]
  }
}
...
probes = {
  probe-api = {
    protocol            = "Http"
    host                = "api-prod.internal.contoso.local"
    path                = "/healthz"
    interval            = 30
    timeout             = 30
