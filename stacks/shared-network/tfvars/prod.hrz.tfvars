...
prod_hub = {
  ...
  subnets = {
    ...
    "appgw-pl" = {
      address_prefixes                              = ["10.13.40.32/27"]
...
prod_spoke = {
  ...
  subnets = {
    ...
    pgflex-auth = {
      address_prefixes = ["10.14.33.0/27"]
      delegations = [{
        name    = "pgflex-auth"
        service = "Microsoft.DBforPostgreSQL/flexibleServers"
        actions = ["Microsoft.Network/virtualNetworks/subnets/join/action"]
...
uat_spoke = {
  ...
  subnets = {
    ...
    pgflex-auth = {
      address_prefixes = ["10.15.33.0/27"]
      delegations = [{
        name    = "pgflex-auth"
        service = "Microsoft.DBforPostgreSQL/flexibleServers"
        actions = ["Microsoft.Network/virtualNetworks/subnets/join/action"]
...
enable_s2s                 = true
s2s_peer_gateway_public_ip = "20.12.222.0"
s2s_peer_address_spaces    = ["172.14.3.0/24"]
s2s_shared_key             = "9wKmm3vBXKKjzK8XpLXMFF.GFpNMVd6HZtsi8Aigwnu_mdaGNk"
s2s_oneway_enable          = true
