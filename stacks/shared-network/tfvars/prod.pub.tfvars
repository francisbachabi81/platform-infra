...
prod_hub = {
  ...
  subnets = {
    ...
    "appgw-pl" = {
      address_prefixes                              = ["172.13.40.32/27"]
...
prod_spoke = {
  ...
  subnets = {
    ...
    # "privatelink-pg" = {
    #   address_prefixes                  = ["172.14.32.0/27"]
    #   private_endpoint_network_policies = "Disabled"
    # }

    # pgflex-auth = {
    #   address_prefixes = ["172.14.33.0/27"]
    #   delegations = [{
    #     name    = "pgflex-auth"
    #     service = "Microsoft.DBforPostgreSQL/flexibleServers"
    #     actions = ["Microsoft.Network/virtualNetworks/subnets/join/action"]
...
uat_spoke = {
  ...
  subnets = {
    ...
    # "privatelink-pg" = {
    #   address_prefixes                  = ["172.15.32.0/27"]
    #   private_endpoint_network_policies = "Disabled"
    # }

    # pgflex-auth = {
    #   address_prefixes = ["172.15.33.0/27"]
    #   delegations = [{
    #     name    = "pgflex-auth"
    #     service = "Microsoft.DBforPostgreSQL/flexibleServers"
    #     actions = ["Microsoft.Network/virtualNetworks/subnets/join/action"]
...
enable_s2s                 = true
s2s_peer_gateway_public_ip = "62.10.243.143"
s2s_peer_address_spaces    = ["10.14.3.0/24"]
s2s_shared_key             = "9wKmm3vBXKKjzK8XpLXMFF.GFpNMVd6HZtsi8Aigwnu_mdaGNk"
