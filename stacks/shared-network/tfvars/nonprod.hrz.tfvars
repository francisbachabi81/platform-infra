...
nonprod_hub = {
  ...
  subnets = {
    ...
    "appgw-pl" = {
      address_prefixes                              = ["10.10.40.32/27"]
...
dev_spoke = {
  ...
  subnets = {
    ...
    pgflex-auth = {
      address_prefixes = ["10.11.33.0/27"]
      delegations = [{
        name    = "pgflex-auth"
        service = "Microsoft.DBforPostgreSQL/flexibleServers"
        actions = ["Microsoft.Network/virtualNetworks/subnets/join/action"]
...
qa_spoke = {
  ...
  subnets = {
    ...
    pgflex-auth = {
      address_prefixes = ["10.12.33.0/27"]
      delegations = [{
        name    = "pgflex-auth"
        service = "Microsoft.DBforPostgreSQL/flexibleServers"
        actions = ["Microsoft.Network/virtualNetworks/subnets/join/action"]
...
enable_s2s                 = true
s2s_peer_gateway_public_ip = "135.119.44.108"
s2s_peer_address_spaces    = ["172.11.3.0/24"]
