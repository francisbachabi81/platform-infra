...
1. [`Download the VPN configuration file from GitHub`](https://github.com/intterra-io/platform-infra/blob/main/docs/azurevpnconfig_np_hrz_vpn_cn.xml)
...
10.10.40.4 dev.horizon.intterra.io
```
